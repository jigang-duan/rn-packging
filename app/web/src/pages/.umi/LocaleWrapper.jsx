...
const localeInfo = {
  'en-US': {
    messages: require('/Users/jigang.duan/WorkSpace/jiagn.duan/egg-ant-design-pro/app/web/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: require('/Users/jigang.duan/WorkSpace/jiagn.duan/egg-ant-design-pro/app/web/src/locales/pt-BR.js').default,
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: require('/Users/jigang.duan/WorkSpace/jiagn.duan/egg-ant-design-pro/app/web/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: require('/Users/jigang.duan/WorkSpace/jiagn.duan/egg-ant-design-pro/app/web/src/locales/zh-TW.js').default,
    locale: 'zh-TW',
